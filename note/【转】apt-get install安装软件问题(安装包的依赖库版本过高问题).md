---
layout: post
title: "【转】apt-get install安装软件问题(安装包的依赖库版本过高问题)"
description: "使用apt-get安装程序时，报告已安装依赖库的版本高于安装包所需的依赖库指定版本"
category: openstack
tags: [openstack]
---
{% include JB/setup %}
...
####6,ubuntu14.04-LTS安装openstack的J版中的trove时也会出现因依赖包版本过高而无法安装的问题
